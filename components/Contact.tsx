  ...
  return (
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <ScrollReveal>
          <SectionHeader title="Get In Touch" subtitle="Have a project in mind or just want to say hi?" />
        </ScrollReveal>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <ScrollReveal delay={100} className="space-y-6">
                 <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
                    I'm currently available for internship and full-time opportunities. 
                    If you have any questions or just want to connect, feel free to drop me a message!
                 </p>
                 
                 <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 p-6 rounded-2xl backdrop-blur-sm">
                    <h4 className="text-blue-600 dark:text-blue-300 font-semibold mb-2">Note on data</h4>
                    <p className="text-sm text-blue-500 dark:text-blue-200/70">
                        This form uses local storage for demonstration purposes. 
            ...
            <ScrollReveal delay={200}>
              <GlassCard className="relative overflow-hidden">
                  <form onSubmit={handleSubmit} className="space-y-4">
                      <div>
                          <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1 ml-1">Name</label>
                      ...
                      <div>
                          <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1 ml-1">Email</label>
                          <div className="relative">
                              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500">
                                  <Mail size={18} />
                              </div>
                      ...
                      <div>
                          <label htmlFor="message" className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1 ml-1">Message</label>
                          <div className="relative">
