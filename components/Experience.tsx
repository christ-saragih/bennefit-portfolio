  ...
  return (
    <section id="experience" className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <ScrollReveal>
          <SectionHeader title="Working Experience" subtitle="My professional journey in software development." />
        </ScrollReveal>
              ...
              <GlassCard className="relative overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <div className="md:col-span-8 lg:col-span-9 border-l-0 md:border-l border-gray-200 dark:border-white/10 md:pl-8">
                    <h4 className="text-xl font-semibold text-blue-600 dark:text-blue-200 mb-4">{exp.role}</h4>
                    ...
                    {exp.techStack && (
                      <div className="flex flex-wrap gap-2">
                        {exp.techStack.map((tech, tIdx) => (
                          <span key={tIdx} className="text-xs px-2 py-1 rounded bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-300">
                            {tech}
                          </span>
                        ))}
                      </div>
