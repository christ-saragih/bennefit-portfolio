import { Experience, Education, Project, Certification, SkillCategory } from './types';
...
export const PERSONAL_INFO = {
  ...
  about: "Bachelor of Applied Science in Software Engineering Technology from IPB University with a GPA of 3.79. Experienced in developing scalable web applications using modern stacks like Next.js, React, Angular, and Express with Prisma. Passionate about creating seamless user experiences and robust backend systems."
};
...
export const EXPERIENCE_DATA: Experience[] = [
  {
    ...
    techStack: ["Angular", "Next.js", "Express", "Prisma", "Bootstrap", "Tailwind", "OpenAI"]
  },
  {
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    role: "Web Developer",
    category: "Internship",
    techStack: ["Next.js", "Tailwind CSS", "Express.js", "Prisma", "OpenAI", "Dify"],
    thumbnail: "https://placehold.co/800x500/1e293b/60a5fa?text=Sisuka+AI+Chatbot",
    images: [
      "https://placehold.co/1200x800/1e293b/60a5fa?text=Sisuka+AI+Chat+Interface",
  ...
  },
  {
    ...
    thumbnail: "https://placehold.co/800x500/1e293b/c084fc?text=AI+Management+System",
    images: [
      "https://placehold.co/1200x800/1e293b/c084fc?text=Knowledge+Base+Manager",
      "https://placehold.co/1200x800/0f172a/c084fc?text=User+Role+Access+Control",
      "https://placehold.co/1200x800/1e293b/c084fc?text=Document+Upload+Flow"
    ],
    description: [
  ...
  },
  {
    ...
    thumbnail: "https://placehold.co/800x500/1e293b/4ade80?text=Canteen+Meal+Planner",
    images: [
      "https://placehold.co/1200x800/1e293b/4ade80?text=Meal+Planning+Calendar",
      "https://placehold.co/1200x800/0f172a/4ade80?text=RFID+Scanning+Interface",
      "https://placehold.co/1200x800/1e293b/4ade80?text=Daily+Checklist+View"
    ],
    description: [
  ...
  },
  {
    ...
    category: "Internship",
    techStack: ["Angular", "Bootstrap", "Express.js", "Prisma"],
    thumbnail: "https://placehold.co/800x500/1e293b/f472b6?text=DPIA+Compliance+Tool",
    images: [
      "https://placehold.co/1200x800/1e293b/f472b6?text=Assessment+Form",
      "https://placehold.co/1200x800/0f172a/f472b6?text=Risk+Matrix+Visualization",
      "https://placehold.co/1200x800/1e293b/f472b6?text=Audit+Trail+Log"
    ],
    description: [
  ...
  },
  {
    ...
    role: "Web Developer",
    category: "Personal",
    techStack: ["React.js", "Tailwind CSS", "Laravel Breeze", "Inertia.js", "Midtrans"],
    thumbnail: "https://placehold.co/800x500/1e293b/fbbf24?text=Streamy+Movie+App",
    images: [
  ...
  },
  {
    ...
    role: "Web Developer",
    category: "Personal",
    techStack: ["PHP Native", "MySQL", "HTML", "CSS", "Bootstrap", "JavaScript"],
    thumbnail: "https://placehold.co/800x500/1e293b/22d3ee?text=TalasGo+E-Commerce",
    images: [
  ...
  },
  {
    ...
    thumbnail: "https://placehold.co/800x500/1e293b/a78bfa?text=Kosanku+Booking",
    images: [
...
export const CERTIFICATIONS_DATA: Certification[] = [
  { name: "Junior Web Developer", issuer: "Indonesian Professional Certification Authority (BNSP)", period: "Oct 2024 – Oct 2027" },
  { name: "Vocational School Graduate Academy", issuer: "Digital Talent Scholarship", period: "Jul 2024" },
  { name: "Learn to Build Web Apps with React", issuer: "Dicoding", period: "Jul 2024 – Jul 2027" },
  { name: "Learn to Build Front-End Web for Beginners", issuer: "Dicoding", period: "Mar 2024 – Mar 2027" },
  { name: "Learn to Back-End Beginner with JavaScript", issuer: "Dicoding", period: "May 2023 – May 2026" }
];

export const SKILLS_DATA: SkillCategory[] = [
  {
    title: "Frontend",
    skills: ["React.js", "Next.js", "Angular", "TypeScript", "Tailwind CSS", "Bootstrap", "HTML5", "CSS3"]
  },
  {
    title: "Backend",
    skills: ["Node.js", "Express.js", "Laravel", "Sequelize ORM", "Prisma ORM", "MySQL", "PostgreSQL", "MongoDB"]
  },
  {
    title: "Tools & Others",
    skills: ["Git", "GitHub", "GitLab", "VS Code", "Figma", "Notion", "Postman", "Jasmine", "Karma", "AI Agents"]
  }
];